...
This project forecasts weekly jewellery demand by category (22K, 24K, Diamonds, Coins) using gold price as an external driver, and converts forecasts into inventory purchase  using lead time demand + safety stock.
